...
func GetEarningsText(conn *utils.Conn, userId int, rawArgs json.RawMessage) (interface{}, error) {
...
func GetFilingText(conn *utils.Conn, userId int, rawArgs json.RawMessage) (interface{}, error) {
...
func GetExhibitList(conn *utils.Conn, userId int, rawArgs json.RawMessage) (interface{}, error) {
...
func GetExhibitContent(conn *utils.Conn, userId int, rawArgs json.RawMessage) (interface{}, error) {
