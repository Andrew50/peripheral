...
<div class="mobile-container">
    ...
    <div class="mobile-bottom-nav">
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16" class="watchlist-icon">
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="currentColor" class="chart-icon">
