            ...
            if message["type"] == "message":
                try:
                    ...
                    if update.get("execution_id") == execution_id:
                        ...
                        if status == "running":
                            print(
                                f"🏃 Execution started on worker: {update.get('worker_node', 'unknown')}"
                            )
                            ...
                            print(
                                f"⏱️ Execution time: {update.get('execution_time_ms', 0)}ms"
                            )
                            ...
                            print(
                                f"❌ Execution failed: {update.get('error_message', 'Unknown error')}"
                            )
                            result_received = True
                            break
