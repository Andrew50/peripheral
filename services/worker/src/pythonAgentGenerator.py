...
class PythonAgentGenerator: 
    ...
    def _getGeneralPythonSystemInstruction(self, prompt: str) -> str:
        ...
        * get_general_data(columns=[], filters={{"tickers": ["AAPL", "MRNA"]}}) -> pandas DataFrame  
        ...
        - Dates should always be in American format, and dates should ALWAYS be chronologically ordered, from earliest to latest on the right, unless the user specifically asks otherwise.
