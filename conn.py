...
class Conn:
    ...
    def _connect_to_redis(self, cache_host, max_retries=None):
        ...
        # Get socket timeout settings from environment variables
        socket_timeout = float(os.environ.get("REDIS_SOCKET_TIMEOUT", "60.0"))
        socket_connect_timeout = float(os.environ.get("REDIS_SOCKET_CONNECT_TIMEOUT", "30.0"))
        
        print(f"Using Redis socket_timeout={socket_timeout}, socket_connect_timeout={socket_connect_timeout}", flush=True)
